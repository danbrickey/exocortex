...
The member_disability entity captures member-level disability data including disability types, descriptions, effective/termination dates, and verification information. This data exists in both legacy_facets and gemstone_facets source systems and needs to be integrated into the Data Vault architecture as effectivity satellites attached directly to the existing h_member hub to properly track temporal changes.
...
- Explain the effectivity satellite pattern for tracking temporal disability changes
