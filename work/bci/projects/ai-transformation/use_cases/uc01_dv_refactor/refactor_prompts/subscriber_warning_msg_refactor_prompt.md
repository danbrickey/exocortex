...
[entity_name] = subscriber_warning_msg
[source_schema].[source_table] = dbo.cmc_sbwm_sb_msg
...
[effectivity_satellites]:
  ...
  - effectivity satellites with all renamed columns from [source_table]
    - src_eff: sbwm_eff_dt from source
    - src_start_date: sbwm_eff_dt from source
    - src_end_date: sbwm_term_dt from source
  - include system columns
[data_dictionary_info] = @docs/sources/facets/dbo_cmc_sbwm_sb_msg.csv
[current_view] = current_subscriber_warning_msg