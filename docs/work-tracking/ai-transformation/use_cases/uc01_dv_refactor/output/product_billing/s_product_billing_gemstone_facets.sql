...
-- Purpose: Effectivity satellite for product billing from gemstone_facets source
...
{{
    config(
        ...
        tags=['raw_vault', 'satellite', 'effectivity', 'product_billing', 'gemstone_facets']
    )
}}

{%- set yaml_metadata -%}
source_model: stg_product_billing_gemstone_facets
