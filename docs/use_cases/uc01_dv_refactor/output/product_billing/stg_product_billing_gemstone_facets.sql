...
-- Purpose: Prepare data from gemstone_facets with hash keys and hashdiffs for vault loading
-- Source: stg_product_billing_gemstone_facets_rename

{%- set yaml_metadata -%}
source_model: stg_product_billing_gemstone_facets_rename
derived_columns:
  record_source: '!gemstone_facets'
