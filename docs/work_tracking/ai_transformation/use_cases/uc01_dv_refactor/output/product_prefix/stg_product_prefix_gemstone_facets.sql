{{
    config(
        materialized='view',
        tags=['staging', 'product_prefix', 'gemstone_facets']
    )
}}

/*
    Staging View: product_prefix (Gemstone Facets)
    Source: stg_product_prefix_gemstone_facets_rename
...
{%- set yaml_metadata -%}
source_model: "stg_product_prefix_gemstone_facets_rename"
derived_columns:
